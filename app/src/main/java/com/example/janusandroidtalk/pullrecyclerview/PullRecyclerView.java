package com.example.janusandroidtalk.pullrecyclerview;
...
import com.example.janusandroidtalk.pullrecyclerview.layoutmanager.ILayoutManager;
...
public class PullRecyclerView extends FrameLayout implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.recycler_pull_layout, this, true);
